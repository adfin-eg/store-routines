...
export function FuturePriceGrid({ selectedItem, onOpenEditPromotion, showMultiSelectMessage }: { selectedItem?: any, onOpenEditPromotion?: () => void, showMultiSelectMessage?: boolean }) {
